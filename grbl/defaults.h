...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_A_STEPS_PER_MM 800.0       // $103 steps (A steps per mm)
  #define DEFAULT_B_STEPS_PER_MM 800.0       // $104 steps (A steps per mm)
  #define DEFAULT_X_MAX_RATE 2500.0           // $110 mm/min (X max speed)
  #define DEFAULT_Y_MAX_RATE 2500.0           // $111 mm/min (Y max speed)
  #define DEFAULT_Z_MAX_RATE 2500.0           // $112 mm/min (Z max speed)
  #define DEFAULT_A_MAX_RATE 2500.0           // $113 mm/min (A max speed)
  #define DEFAULT_B_MAX_RATE 2500.0           // $114 mm/min (B max speed)
  ...
  #define DEFAULT_A_ACCELERATION (200.0*60*60)// $123 mm/min^2 (A max acceleration)
  #define DEFAULT_B_ACCELERATION (200.0*60*60)// $124 mm/min^2 (A max acceleration)
  #define DEFAULT_X_MAX_TRAVEL 203.0         // $130 mm (X max travel; must be positive)
  #define DEFAULT_Y_MAX_TRAVEL 123.0         // $131 mm (Y max travel; must be positive)
  #define DEFAULT_Z_MAX_TRAVEL 73.0         // $132 mm (Z max travel; must be positive)
  #define DEFAULT_A_MAX_TRAVEL 360.0           // $133 mm (A max travel; must be positive)
  #define DEFAULT_B_MAX_TRAVEL 360.0           // $134 mm (B max travel; must be positive)
  ...
  #define DEFAULT_B_CURRENT 0.0              // $144 amps (B stepper current [disabled])
  ...
  #define DEFAULT_HOMING_SEEK_RATE 2500.0     // $25 mm/min (homing search speed)
  ...
  #define DEFAULT_SPINDLE_RPM_MAX 12000.0     // $30 RPM (spindle speed for max 5V PWM output)
  #define DEFAULT_SPINDLE_RPM_MIN 1000.0        // $31 RPM (spindle speed for min 20mV PWM output)
